export default function Skills() {
  const skillset = {
    "Languages & Tools": ["Python", "C++", "C#", "Typescript", "JavaScript", "Git", "Postman", "Firebase"],
    "Frameworks & Libraries": ["React.js", "Node.js", "Node.js", "TailwindCSS", "Framer Motion"],
    "A": ["A"]
  };
        ...
        {Object.entries(skillset).map(([category, skills]) => (
          <div key={category}>
            ...
            <ul className="flex flex-wrap gap-4">
              {skills.map(skill => (
                <li key={skill} className="px-4 py-2 bg-neutral-900 text-neutral-300 text-sm rounded-full border border-neutral-800 uppercase tracking-widest">{skill}</li>
              ))}
            </ul>
          </div>
        ))}
